  ...
  if (role === "Manager") {
    newHTML = `<div class="col-3 shadow rounded mx-3 my-3">
        ...
        <div class="bg-light row">
          ...
          <p class="border border-danger">Email: <a href="mailto:${email}">${email}</a> </p>
    ...
    newHTML = `<div class="col-3 shadow rounded mx-3 my-3">
        ...
        <div class="bg-light row">
          <p class="border border-danger">Employee ID: ${id}</p>
          <p class="border border-danger">Email: <a href="mailto:${email}">${email}</a></p>
          <p class="border border-danger">Github Profile:<a href= "http://github.com/${employee.getGithub()}" target="blank">${employee.getGithub()}</a></p>
        </div>
        </div>`;
  } else if (role === "Intern") {
    newHTML = `<div class="col-3 shadow rounded mx-3 my-3">
